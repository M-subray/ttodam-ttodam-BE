...
import com.ttodampartners.ttodamttodam.domain.user.service.ProfileEditViewService;
...
public class ProfileEditViewController {
  private final ProfileEditViewService profileEditViewService;

  @GetMapping("users/profiles/update")
  public ResponseEntity<ProfileDto> getProfile() {
    ProfileDto profile = profileEditViewService.getProfile();
